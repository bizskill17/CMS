function IconSvg({ name }) {
  const icons = {
    ...
    call: (
      <>
        <path d="M7.5 5.5c.7-.7 1.8-.7 2.5 0l1.7 1.7c.7.7.7 1.8 0 2.5l-1.1 1.1c1 1.8 2.5 3.2 4.3 4.3l1.1-1.1c.7-.7 1.8-.7 2.5 0l1.7 1.7c.7.7.7 1.8 0 2.5l-1.1 1.1c-.8.8-2 1.1-3.1.8-2.7-.8-5.4-2.6-7.8-4.9-2.3-2.3-4.1-5.1-4.9-7.8-.3-1.1 0-2.3.8-3.1l1.1-1.1Z" />
      </>
    ),
    user: (
      <>
    ...
    pencil: (
      <>
        <path d="m14 4.5 5.5 5.5-12 12h-5.5v-5.5l12-12Z" />
    ...
    delete: (
      <>
        <path d="M5.5 6.5h13" />
        <path d="M9.5 6.5v-1a1.5 1.5 0 0 1 1.5-1.5h2a1.5 1.5 0 0 1 1.5 1.5v1" />
        <path d="M17.5 6.5v11a2.5 2.5 0 0 1-2.5 2.5h-6A2.5 2.5 0 0 1 6.5 17.5v-11" />
